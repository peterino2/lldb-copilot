...
//
//===----------------------------------------------------------------------===//
// This file is GENERATED from Dwarf.def. DO NOT EDIT.
// Generated for LLVM 21.1.8 compatibility.
//===----------------------------------------------------------------------===//

#ifndef LLDB_API_SBLANGUAGES_H
#define LLDB_API_SBLANGUAGES_H

#include <cstdint>

namespace lldb {

/// Indicates which programming language or version a type or function came
/// from. The values are defined by DWARF 6 (draft).
